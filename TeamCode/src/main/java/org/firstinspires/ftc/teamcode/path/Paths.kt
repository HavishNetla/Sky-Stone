...
var blockPositions: List<PathPoint> = listOf(
        ...
        PathPoint(Vector2d(108.14, 87.625), Math.toRadians(83.75), 0.3, 0.3, "fourth block"),
...
class Paths {
    ...
    fun moveTowardsPlatfrom(pose: Pose2d, loc: Int): PathFollower {
        ...
        when (loc) {
            1 -> t.addPoint(Vector2d(105.0, 330.72), Math.PI, 0.25, 0.25, "moving forward3")
                    .addPoint(Vector2d(78.0, 220.08), Math.PI, 0.4, 0.25, "moving forward1")
                    .addPoint(Vector2d(78.0, 220.98), Math.PI, 0.4, 0.25, "moving forward2")
            2 -> t.addPoint(Vector2d(105.0, 320.72), Math.PI, 0.25, 0.25, "moving forward3")
                    .addPoint(Vector2d(78.0, 220.08), Math.PI, 0.4, 0.25, "moving forward1")
                    .addPoint(Vector2d(78.0, 220.98), Math.PI, 0.4, 0.25, "moving forward2")
            else -> t.addPoint(Vector2d(105.0, 310.72), Math.PI, 0.25, 0.25, "moving forward3")
                    .addPoint(Vector2d(78.0, 220.08), Math.PI, 0.4, 0.25, "moving forward1")
                    .addPoint(Vector2d(78.0, 220.98), Math.PI, 0.4, 0.25, "moving forward2")
        }
