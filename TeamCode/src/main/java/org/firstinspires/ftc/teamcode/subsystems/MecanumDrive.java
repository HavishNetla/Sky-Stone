...
public class MecanumDrive extends Subsystem {
  ...
  public void waitForPathFollower() {
    System.out.println("statut: " + getMode());
  ...
  public void update() {
    ...
    switch (mode) {
      case OPEN_LOOP:
        ...
        break;
      case FOLLOW_PATH:
        pathPowers = pathfollower.update(followAngle, position, 0.2, 0.2);
        System.out.println(
            "statut: " + "before " + pathfollower.getName() + " " + isPathFollowingDone);
        isPathFollowingDone = pathfollower.getStatus();
        System.out.println("statut: " + isPathFollowingDone);
